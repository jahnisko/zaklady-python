...
x = 0
# global = 1 -> nesmí být název proměnné global, má ji zarezervovaný Python
number_global = 1
PI = 3.14
city = "Opava"
# hilda@sspu-opava.cz = 'Hilda Dokonalá' -> neplatný znak @
hilda_zavinac_sspu_pomlcka_opava_tecka_cz = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
# 007agent = 'James Bond' -> nesmí začínat číslicí
agent007 = 'James Bond'
