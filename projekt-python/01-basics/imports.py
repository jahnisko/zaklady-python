...
print("Aktualni cas", actual)

import dateutil.easter
i = [2021, 2022, 2023, 2024, 2025, 2026]
for x in i:
    print("Vel. nedele", x, ":", dateutil.easter.easter(x))

from dateutil.rrule import *
year = rrule(YEARLY, dtstart=actual, bymonth=12, bymonthday=24, byweekday=FR)[0].year
print("Stedry den v patek roku", year)
