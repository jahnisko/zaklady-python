...
print("students_count", type(students_count), "rating", type(rating), "is_published", type(is_published))
print("students_count", id(students_count), "rating", id(rating), "is_published", id(is_published))
# Numerické operátory
# print(10 + 3)
# print(10 - 3)
# print(10 * 3)
...
#>>, << (bitové posuvy), ~ (vlnovka = binární komplement), | (bitové or), & (bitové and), ^ (stříška = bitové xor)
